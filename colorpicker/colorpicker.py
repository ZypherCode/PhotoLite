...
from PyQt6.QtCore import (QPoint, Qt, pyqtSignal, QRegularExpression)
from PyQt6.QtGui import QColor, QMouseEvent, QRegularExpressionValidator
...
class ColorPicker(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.red.setMaxLength(3)
        self.ui.green.textEdited.connect(self.rgbChanged)
        self.ui.green.setMaxLength(3)
        self.ui.blue.textEdited.connect(self.rgbChanged)
        self.ui.blue.setMaxLength(3)
        self.ui.hex.textEdited.connect(self.hexChanged)
        self.ui.hex.setValidator(QRegularExpressionValidator(QRegularExpression('^[0-9a-fA-F]+$')))
    ...
    def _setHSV(self, c):
        self.ui.hue_selector.move(QPoint(7, int((100 - c[0]) * 1.85)))
        ...
        self.ui.selector.move(QPoint(int(c[1] * 2 - 6), int((200 - c[2] * 2) - 6)))
    ...
    def moveSVSelector(self, event):
        if event.buttons() == Qt.MouseButton.LeftButton:
            ...
            self.ui.selector.move(QPoint(int(pos.x() - 6), int(pos.y() - 6)))
            self.hsvChanged()
